    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('pengajar.update', $pengajars->id) }}" method="POST"
                            class="mb-3 needs-validation" novalidate>
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
                                <label for="nama" class="form-label">Nama</label>
                                <input type="text" class="form-control" id="nama" name="nama" value="{{ $pengajars->nama }}"
                                    required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="email" name="email"
                                    value="{{ $pengajars->email }}" required>
                                <div class="form-text">Masukkan Email Utama Anda</div>
                                <div class="valid-feedback">
                                    Bagus
                                </div>
                                <div class="invalid-feedback">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control" id="no_telp" name="no_telp" pattern="08[0-9]{8,11}"
                                    placeholder="08XXXXXXXXXX" value="{{ $pengajars->no_telp }}" required>
