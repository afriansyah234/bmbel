    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('pendaftar.store') }}" method="POST" class="mb-3 needs-validation"
                            novalidate>
                            @csrf
                            <div class="mb-3">
                                <label for="nama_pendaftar" class="form-label">Nama pendaftar</label>
                                <input type="text" class="form-control" name="nama_pendaftar" id="nama_pendaftar" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control" name="tanggal_daftar" id="tanggal_daftar"
                                    value="{{ old('tanggal_daftar', $tanggal) }}" readonly>
                                <div class="valid-feedback">
                                    Bagus
                                </div>
                                <div class="invalid-feedback">
